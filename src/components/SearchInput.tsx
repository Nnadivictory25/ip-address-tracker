...
const SearchInput = ({ onSubmit }: Props) => {
    ...
    return (
        <form action="#" onSubmit={(e) => handleSubmit(e)} className="w-[90%] mx-auto max-w-xl mt-7 flex items-center">
            <input ref={inputRef} required minLength={11} type="tel" className="bg-white rounded-l-xl text-lg h-14 px-4 w-full outline-none" placeholder="Search for any IP address" />
